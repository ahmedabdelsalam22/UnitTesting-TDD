...
import 'package:posts_with_unit_testing/cubit/posts_cubit.dart';
import 'package:posts_with_unit_testing/models/post_model.dart';
import 'package:posts_with_unit_testing/repository/posts_repository.dart';
...
void main() {
  ...
  test('''PostsCubit should emit PostsLoading then PostsLoaded State
       with a list of posts when calling loadPosts method''', () async {
    //arrange
